...
import com.app.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean mouseover(WebDriver driver, WebElement ele) {
		...
		try {
			...
			/*
			 * if (flag) {
			 * SuccessReport("MouseOver ","MouserOver Action is performed on \""
			 * +locatorName +"\""); } else { failureReport(
			 * "MouseOver","MouseOver action is not performed on \""
			 * +locatorName+"\""); }
			 */
		}
	}
